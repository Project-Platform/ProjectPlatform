...
console.log(props.details)
  return (
    <div className="min-h-screen">
      ...
      <h2 className="font-medium text-lg ml-[18vw] mt-[1vw]">Authors:{props.author1},{props.author2}
      </h2>

      <h2 className="font-medium text-lg ml-[18vw]">Date:{props.date}</h2>

      <h2 className="font-medium text-lg ml-[18vw]">Domain:{props.domain1},{props.domain2}</h2>
      <h2 className="font-medium text-lg ml-[18vw]">Field:{props.field}</h2>

      <p className="p-5 mx-60  text-xl ">
     {props.abstract}
      </p>
