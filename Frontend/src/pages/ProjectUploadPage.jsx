    ...
    <div className="font-Arial m-0 p-0 bg-beige">
      ...
      <div className="flex items-center justify-center font-Arial m-0 p-0 bg-beige min-h-screen">
        <section className="flex flex-col md:flex-row mx-auto p-8 md:p-12 bg-whitesmoke shadow-md rounded-8">
          ...
          >
            <div className="md:col-span-2 lg:col-span-1 bg-palevioletred text-blanchedalmond p-3 md:p-12 rounded-4 text-18 font-bold text-xl">
            ...
            <div className="md:col-span-2 lg:col-span-1 bg-palevioletred text-blanchedalmond p-3 md:p-12 rounded-4 text-18 font-bold text-xl">
              Document (PDF or word format, up to 10MB):
            </div>
            <div className="translate y-50 md:col-span-2 lg:col-span-1">
              <input
                type="file"
                id="ideaTemplate"
                name="ideaTemplate"
